 ...
 *  
 */
package de.hybris.advancedexport.jalo;
...
import de.hybris.advancedexport.constants.AdvancedexportConstants;



/**
 * This is the extension manager of the Advancedexport extension.
 */
public class AdvancedexportManager extends GeneratedAdvancedexportManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(AdvancedexportManager.class.getName());
	 ...
	 */
	public static AdvancedexportManager getInstance()
	{
		return (AdvancedexportManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				AdvancedexportConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AdvancedexportManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AdvancedexportManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of AdvancedexportManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of AdvancedexportManager called, current tenant: " + getTenant().getTenantID());
		}
	}
