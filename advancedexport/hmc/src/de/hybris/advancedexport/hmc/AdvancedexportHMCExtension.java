 ...
 *  
 */
package de.hybris.advancedexport.hmc;
...
/**
 * Provides necessary meta information about the advancedexport hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class AdvancedexportHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(AdvancedexportHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "de.hybris.advancedexport.hmc.locales";
