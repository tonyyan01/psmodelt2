...
/**
 * This is the extension manager of the Hacfix extension.
 */
public class HacfixManager extends GeneratedHacfixManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(HacfixManager.class);
	 ...
	 */
	public static HacfixManager getInstance()
	{
		return (HacfixManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(HacfixConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public HacfixManager() // NOPMD 
	{
		LOG.debug("constructor of HacfixManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of HacfixManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of HacfixManager called, current tenant: {}", getTenant().getTenantID());
	}
