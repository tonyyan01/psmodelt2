...
public class DefaultHacfixService implements HacfixService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultHacfixService.class);
	...
	{
		return DefaultHacfixService.class.getResourceAsStream("/hacfix/sap-hybris-platform.png");
	}
