...
import com.hybris.backoffice.constants.CollatesortConstants;
 ...
 */
public class CollatesortManager extends GeneratedCollatesortManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CollatesortManager.class.getName());
	 ...
	 */
	public static CollatesortManager getInstance()
	{
		return (CollatesortManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CollatesortConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CollatesortManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CollatesortManager called.");
		}
	}
